...
public class RSA {
	...
	public static BigInteger[] keys(BigInteger n1, BigInteger n2)
	{
		...
		BigInteger coefficient = n2.modInverse(n1);
		BigInteger exponent1 = d.mod(n1.subtract(BigInteger.ONE));
		BigInteger exponent2 = d.mod(n2.subtract(BigInteger.ONE));
		System.out.println("coefficient: " + coefficient);
		System.out.println("exponent1: " + exponent1);
		System.out.println("exponent2: " + exponent2);
		System.out.println("modulus is: " + pq);
		System.out.println("ola of n is: " + ola);
		System.out.println("publicExponent is: " + e);
		System.out.println("privateExponent is: " + d);
	...
	public static void main(String args[]) {
		 ...
		 System.out.println("prime1 : " + n1);
	 System.out.println("prime2 : " + n2);
